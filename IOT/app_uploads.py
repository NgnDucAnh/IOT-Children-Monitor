...
# Khai báo UPLOAD_DIR (Đã bị comment out ở bản gốc, gây lỗi)
# Vì code hiện tại chỉ dùng S3 và TEMP_DIR, nên ta dùng TEMP_DIR thay thế
...
S3_RESULTS_KEY = f'{IOT_BASE_FOLDER}/history.txt' # Sử dụng biến này, ghi đè biến môi trường

if not api_key or not S3_BUCKET_NAME or not AWS_ACCESS_KEY_ID or not AWS_SECRET_ACCESS_KEY or not AWS_REGION:
...
def upload():
    ...
    try:
        ...
        # Xử lý ảnh trong luồng riêng để tránh khóa HTTP request
...
def results():
    """ENDPOINT: Trả về LỊCH SỬ LOG từ S3 và PRE-SIGNED URL cho ảnh"""
